...
const rows = [
  ...
  { id: ' Geography', numeric: false, disablePadding: true, label: ' Geography' },
];
                ...
                .map(n => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <CustomTableCell align="left">{n.OrganizationName}</CustomTableCell>
                      <CustomTableCell align="left">{n.PlanType}</CustomTableCell>
                      <CustomTableCell align="left">{n.Product}</CustomTableCell>
                      <CustomTableCell align="left">{n.Segment}</CustomTableCell>
                      <CustomTableCell align="left">{n.Geography}</CustomTableCell>
                    </TableRow>
                  );
                })}
              {emptyRows > 0 && (
